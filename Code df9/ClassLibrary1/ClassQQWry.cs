...
//string roll;
//roll = Request.Cookies["PPusernameBB"]["RollNumber"];
//roll = roll + " " + Request.Cookies["PPusernameBB"]["username"];
//roll = roll + " " + Request.Cookies["PPusernameBB"]["password"];
//roll = roll + " " + Request.Cookies["PPusernameBB"]["nowtime"];
//Label1.Text = roll;