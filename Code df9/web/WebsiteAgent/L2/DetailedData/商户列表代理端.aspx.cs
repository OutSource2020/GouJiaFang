...
{
    public partial class 商户列表代理端 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ClassLibrary1.ClassAccount.验证账号代理L2端();
            }
        ...
        private void BindGrid(string 时间导入绑定)
        {
            ...
            string strQuery = "SELECT 商户ID,商户名称 FROM table_商户账号 where 所属代理L2='"+ Cookie_UserName + "' and " + 时间导入绑定 + " order by 时间注册 desc  LIMIT " + 分页() + " ";
