<%@ Page Title="商户统计充值余额" Language="C#" MasterPageFile="~/WebsiteAgent/L1/SiteTemplateAgentL1.Master" AutoEventWireup="true" CodeBehind="商户统计提款笔数.aspx.cs" Inherits="web1.WebsiteAgent.L1.DetailedData.商户统计提款笔数" %>
...
<div>
    <table class="auto-style1">  
        ...
        <tr>
            <td>
                <asp:Label ID="Label_提款笔数" runat="server" Text="Label_提款笔数"></asp:Label>
            </td>
            <td>
                <asp:Label ID="Label_提款金额" runat="server" Text="Label_提款金额"></asp:Label>
            </td>
            <td>
...
<Columns>
                    ...
                    <asp:BoundField DataField="count(A.手续费)" HeaderText="手续费笔数" />
                    <asp:BoundField DataField="sum(A.交易金额)" HeaderText="交易金额(合计)" />
                    <asp:BoundField DataField="sum(A.手续费)" HeaderText="手续费金额" />
