<%@ Page Title="商户统计充值手续费" Language="C#" MasterPageFile="~/WebsiteAgent/L1/SiteTemplateAgentL1.Master" AutoEventWireup="true" CodeBehind="商户统计充值手续费.aspx.cs" Inherits="web1.WebsiteAgent.L1.DetailedData.商户统计充值手续费" %>
...
<div>
    <table class="auto-style1">  
        ...
        <tr>
            <td>
                <asp:Label ID="Label_充值笔数" runat="server" Text="Label_充值笔数"></asp:Label>
            </td>
            <td>
                <asp:Label ID="Label_充值金额" runat="server" Text="Label_充值金额"></asp:Label>
            </td>
            <td>
