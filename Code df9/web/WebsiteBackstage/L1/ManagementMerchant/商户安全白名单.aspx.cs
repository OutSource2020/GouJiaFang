...
{
    public partial class 商户安全白名单 : System.Web.UI.Page
    {
        ...
        protected void Button_新增商户白名单IP_Click(object sender, EventArgs e)
        {
            Response.Redirect("商户安全白名单新增.aspx");
        }
        ...
        {
            string strQuery = "SELECT 编号,商户ID,商户白名单IP,商户白名单备注,状态,时间创建 FROM table_商户白名单管理 " + 时间导入绑定 + " order by 时间创建 desc";
