<%@ Page Title="商户列表充值手续费" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="商户列表充值手续费.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementMerchant.商户列表充值手续费" %>
     ...
     <table class="auto-style1">
        ...
        <tr>
            <td style="width: 30%">
                ...
                <asp:Button ID="Button_操作充值" runat="server" class="btn btn-info btn-fw" OnClick="Button_操作充值_Click" Text="操作充值" UseSubmitBehavior="false" OnClientClick="this.disabled=true;this.value='处理中...';" />
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
