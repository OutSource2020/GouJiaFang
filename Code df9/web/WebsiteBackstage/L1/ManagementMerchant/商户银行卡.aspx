<%@ Page Title="商户银行卡" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="商户银行卡.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementMerchant.商户银行卡" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td>
                ...
                <asp:RadioButton ID="RadioButton_状态待审核" runat="server" GroupName="DenHinTai" Text="待审核" type="radio" value="待审核" AutoPostBack="True" OnCheckedChanged="RadioButton_状态待审核_CheckedChanged" />
...
<Columns>
                    ...
                    <asp:BoundField DataField="商户银行卡卡号" HeaderText="商户银行卡卡号" />
                    <asp:BoundField DataField="商户银行名称" HeaderText="商户银行名称" />
                    <asp:BoundField DataField="商户银行卡主姓名" HeaderText="商户银行卡主姓名" />
                    <asp:BoundField DataField="商户银行卡卡标记" HeaderText="商户显示标记" />
                    <asp:BoundField DataField="状态" HeaderText="状态" />
                    <asp:BoundField DataField="时间创建" HeaderText="创建时间" />
                    <asp:HyperLinkField Text="操作" DataNavigateUrlFields="编号" DataNavigateUrlFormatString="商户银行卡更新.aspx?Bianhao={0}" />
                </Columns>
