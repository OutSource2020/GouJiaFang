<%@ Page Title="手续费交易明细" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="手续费交易明细.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementMerchant.手续费交易明细" %>
...
<Columns>
            ...
            <asp:BoundField DataField="手续费收入" HeaderText="手续费收入" />
            <asp:BoundField DataField="手续费支出" HeaderText="手续费支出" />
            <asp:BoundField DataField="交易前手续费余额" HeaderText="交易前手续费余额" />
            <asp:BoundField DataField="交易后手续费余额" HeaderText="交易后手续费余额" />
