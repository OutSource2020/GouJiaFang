...
{
    public partial class 商户银行卡 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("./商户银行卡更新.aspx");
        }
        ...
        protected void RadioButton_状态待审核_CheckedChanged(object sender, EventArgs e)
        {
            BindGrid("where " + 查看勾选了哪些() + " ");
        }
