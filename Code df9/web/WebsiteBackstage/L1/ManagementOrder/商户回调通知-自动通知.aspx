<%@ Page Title="商户回调通知-自动通知" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="商户回调通知-自动通知.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementOrder.商户回调通知_自动通知" %>
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="Button_自动通知" runat="server" Text="自动通知" class="btn btn-info btn-fw" OnClick="Button_自动通知_Click" />
                    </td>
                </tr>
            </table>
        </div>
