<%@ Page Title="代理列表L2" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="代理列表L2.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementAgent.SettingL2.代理列表L2" %>
...
<Columns>
        ...
        <asp:HyperLinkField Text="操作" DataNavigateUrlFields="代理ID" DataNavigateUrlFormatString="代理列表L2设置.aspx?Bianhao={0}" />
    </Columns>
