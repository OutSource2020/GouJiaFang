<%@ Page Title="代理列表L2设置信息" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="代理列表L2设置信息.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementAgent.SettingL2.代理列表L2设置信息" %>
     ...
     <table class="auto-style1">
        ...
        <tr>
            <td style="width:  30%">
                代理名称</td>
            <td>
                <asp:TextBox ID="TextBox_代理名称" runat="server" Width="160px" MaxLength="30" AutoCompleteType="Disabled"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width:  30%">
        ...
        <tr>
            <td style="width:  30%">
                所属代理L1</td>
            <td>
                <asp:DropDownList ID="DropDownList_所属代理" runat="server">
                    <asp:ListItem Text="未选择" Value="未选择" />
                </asp:DropDownList>
            </td>
        </tr>
