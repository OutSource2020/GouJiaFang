<%@ Page Title="代理列表L2设置" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="代理列表L2设置.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementAgent.SettingL2.代理列表L2设置" %>
