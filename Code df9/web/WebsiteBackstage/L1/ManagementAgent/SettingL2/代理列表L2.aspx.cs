...
{
    public partial class 代理列表L2 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("代理列表L2新增.aspx");
        }
        ...
        {
            string strQuery = "SELECT 代理ID,代理名称,所属代理L1,时间最后登入,时间注册,状态 FROM table_代理账号等级2 " + 时间导入绑定 + " order by 时间注册 desc";
