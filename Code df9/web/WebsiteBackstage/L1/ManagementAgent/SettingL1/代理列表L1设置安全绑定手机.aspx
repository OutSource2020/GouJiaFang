<%@ Page Title="代理列表L1设置安全绑定手机" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="代理列表L1设置安全绑定手机.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementAgent.SettingL1.代理列表L1设置安全绑定手机" %>
