...
{
    public partial class 后台账号安全白名单 : System.Web.UI.Page
    {
        ...
        protected void Button_新增后台白名单IP_Click(object sender, EventArgs e)
        {
            Response.Redirect("后台账号安全白名单新增.aspx");
        }
        ...
        {
            string strQuery = "SELECT 编号,后台ID,后台白名单IP,后台白名单备注,状态,时间创建 FROM table_后台白名单管理 " + 时间导入绑定 + " order by 时间创建 desc";
