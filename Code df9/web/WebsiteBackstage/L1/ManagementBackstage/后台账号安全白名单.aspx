<%@ Page Title="后台账号安全白名单" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="后台账号安全白名单.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementBackstage.后台账号安全白名单" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="DropDownList1" runat="server" Width="100px" AutoPostBack="True">
                    ...
                    <asp:ListItem Value="后台白名单IP">后台白名单IP</asp:ListItem>
                </asp:DropDownList>
        ...
        <tr>
            <td style="width: 511px">
                ...
                <asp:Button ID="Button_新增后台白名单IP" runat="server" class="btn btn-info btn-fw" OnClick="Button_新增后台白名单IP_Click" Text="新增后台白名单IP"/>
            </td>
            <td>
...
<Columns>
                    ...
                    <asp:BoundField DataField="后台白名单IP" HeaderText="后台白名单IP" />
                    <asp:BoundField DataField="后台白名单备注" HeaderText="后台白名单备注" />
                    <asp:BoundField DataField="状态" HeaderText="状态" />
                    <asp:BoundField DataField="时间创建" HeaderText="时间创建" />
                    

        <asp:HyperLinkField Text="操作" DataNavigateUrlFields="编号" DataNavigateUrlFormatString="后台账号安全白名单更新.aspx?Bianhao={0}" />
    </Columns>
