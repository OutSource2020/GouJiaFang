<%@ Page Title="后台账号列表" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="后台账号列表.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementBackstage.后台账号列表" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_NR1" runat="server">

</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_NR2" runat="server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="DropDownList_筛选关键字" runat="server" Width="100px">
                    ...
                    <asp:ListItem Value="后台ID">后台ID</asp:ListItem>
                    <asp:ListItem Value="后台账号名称">后台账号名称</asp:ListItem>
                </asp:DropDownList>
        ...
        <tr>
            <td>
                ...
                <asp:Button ID="Button_新增后台账号" runat="server" class="btn btn-info btn-fw" OnClick="Button_新增后台账号_Click" Text="新增后台账号" />
             </td>
            <td>
...
<Columns>
                    <asp:BoundField DataField="后台ID" HeaderText="后台ID" />
                    <asp:BoundField DataField="后台账号名称" HeaderText="后台账号名称" />
                    <asp:BoundField DataField="后台账号分级" HeaderText="后台账号分级" />
                    ...
                    <asp:HyperLinkField Text="操作" DataNavigateUrlFields="后台ID" DataNavigateUrlFormatString="后台账号列表设置.aspx?Bianhao={0}" />
                </Columns>
