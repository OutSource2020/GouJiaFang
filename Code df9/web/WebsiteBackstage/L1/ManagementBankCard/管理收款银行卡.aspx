<%@ Page Title="管理收款银行卡" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="管理收款银行卡.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementBankCard.管理收款银行卡" %>
        ...
        <tr>
            <td>
                ...
                <asp:DropDownList ID="DropDownList_关键字" runat="server" Width="100px" AutoPostBack="True">
                    ...
                    <asp:ListItem Value="收款银行卡名称">收款银行卡名称</asp:ListItem>
                    <asp:ListItem Value="收款银行卡卡号">收款银行卡卡号</asp:ListItem>
                    <asp:ListItem Value="收款银行名称">收款银行名称</asp:ListItem>
                    <asp:ListItem Value="收款银行卡主姓名">收款银行卡主姓名</asp:ListItem>
                </asp:DropDownList>
...
<Columns>
                    ...
                    <asp:BoundField DataField="收款银行名称" HeaderText="收款银行名称" />
                    <asp:BoundField DataField="收款银行卡余额" HeaderText="收款银行卡余额" />
                    <asp:BoundField DataField="收款银行卡主姓名" HeaderText="收款银行卡主姓名" />
                    <asp:BoundField DataField="收款银行卡主电话" HeaderText="收款银行卡主电话" />
