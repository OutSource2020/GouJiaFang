<%@ Page Title="管理出款银行卡卡更新" Language="C#" MasterPageFile="~/WebsiteBackstage/L1/SiteTemplateBackstageL1.Master" AutoEventWireup="true" CodeBehind="管理出款银行卡卡更新.aspx.cs" Inherits="web1.WebsiteBackstage.L1.ManagementBankCard.管理出款银行卡卡更新" %>
     ...
     <table class="auto-style1">
        ...
        <tr>
            <td style="width: 30%">
                出款出款银行卡名称</td>
            <td>
                <asp:Label ID="Label_出款银行卡名称" runat="server" Text="Label_出款出款银行卡名称"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 30%">
        ...
        <tr>
            <td style="width: 30%">
                出款银行名称</td>
            <td>
                <asp:TextBox ID="TextBox_出款银行名称" runat="server" Width="160px" MaxLength="30" AutoCompleteType="Disabled"></asp:TextBox>
                <asp:Button ID="Button_识别出款银行名称" runat="server" Text="识别出款银行名称" OnClick="Button_识别出款银行名称_Click" />
            </td>
        </tr>
        <tr>
            <td style="width: 30%">
                出款银行卡余额</td>
            <td>
                <asp:Label ID="Label_出款银行卡余额" runat="server" Text="Label_出款银行卡余额"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 30%">
