...
namespace web1.WebsiteBackstage.L2
{
    public partial class SiteTemplateBackstageL2 : System.Web.UI.MasterPage
    {
        ...
        {
            if (ClassLibrary1.ClassAccount.检查管理L2端cookie() == true)
            {
            ...
            {
                ClassLibrary1.ClassAccount.弹回登入管理L2页();
            }
