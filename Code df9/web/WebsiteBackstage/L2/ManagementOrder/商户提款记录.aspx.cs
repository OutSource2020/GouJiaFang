...
namespace web1.WebsiteBackstage.L2.ManagementOrder
{
    public partial class 商户提款记录 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ClassLibrary1.ClassAccount.验证账号管理L2端();
                GetData();
        ...
        protected void TimerTick(object sender, EventArgs e)
        {
            ...
            LabeL2.Text = "载入时间: " + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
      ...
      if (条件4 == null)
        ...
        {
            return 查询组合商户() + 获得订单状态() + 获得类型() + 获得创建方式() + 获得筛选关键字() + 获得筛选端金额() + 获得区间金额() + 获得时间();
        }
        ...
        {
            string strQuery = "select 订单号,商户ID,出款银行卡名称,出款银行卡卡号,交易方姓名,交易方卡号,交易方银行,交易金额,时间创建,时间完成,创建方式,状态,操作员 FROM table_商户明细提款 " + 时间导入绑定 + " order by id desc  LIMIT " + 分页() + " ";
            DataTable dt = new DataTable();
