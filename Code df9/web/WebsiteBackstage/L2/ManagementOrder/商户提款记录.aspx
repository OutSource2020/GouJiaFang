<%@ Page Title="商户提款记录" Language="C#" MasterPageFile="~/WebsiteBackstage/L2/SiteTemplateBackstageL2.Master" AutoEventWireup="true" CodeBehind="商户提款记录.aspx.cs" Inherits="web1.WebsiteBackstage.L2.ManagementOrder.商户提款记录" %>
...
<asp:Label ID="LabeL2" runat="server" Text="载入时间"></asp:Label>
