<%@ Page Language="C#" AutoEventWireup="true" Title="登入管理" CodeBehind="登入.aspx.cs" Inherits="web1.WebsiteBackstage.L2.Login.登入" %>
...
body {
  ...
  background: -webkit-linear-gradient(right, #FFFFF2, #FFBC42);
  background: -moz-linear-gradient(right, #FFFFF2, #FFBC42);
  background: -o-linear-gradient(right, #FFFFF2, #FFBC42);
  background: linear-gradient(to left, #FFFFF2, #FFBC42);
  font-family: "Roboto", sans-serif;
...
<div class="login-page">
  <div>
    ...
    <asp:TextBox ID="TextBox_输入员工号" runat="server" placeholder="KEY" MaxLength="30"></asp:TextBox>
