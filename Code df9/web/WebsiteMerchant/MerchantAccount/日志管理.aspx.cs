...
{
    public partial class 日志管理 : System.Web.UI.Page
    {
        public static string 时间字段 = "时间操作";
        ...
        protected void CheckBox_选择框筛选IP地址_CheckedChanged(object sender, EventArgs e)
        {
            if (CheckBox_选择框筛选IP地址.Checked == true)
            {
                TextBox_筛选IP地址.Enabled = true;
            }
            else
            {
                TextBox_筛选IP地址.Enabled = false;
            }
        }
        ...
        public string 获得筛选IP地址()
        {
            ...
            if (CheckBox_选择框筛选IP地址.Checked == true)
            {
                ...
                string redkey = TextBox_筛选IP地址.Text;
                if (redkey == null)
                {
        ...
        private void GetCustomers()
        {
            ...
            {
                using (MySqlCommand cmd = new MySqlCommand("SELECT 编号,商户ID,时间操作,IP FROM table_商户日志管理", con))
                {
        ...
        private void BindGrid(string 时间导入绑定)
        {
            ...
            string strQuery = "SELECT 编号,商户ID,时间操作,IP FROM table_商户日志管理 where 商户ID='" + Cookie_UserName + "' " + 时间导入绑定 + " order by 时间操作 desc";
