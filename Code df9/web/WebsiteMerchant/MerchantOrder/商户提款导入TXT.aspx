<%@ Page Title="商户提款导入TXT" Language="C#" MasterPageFile="~/WebsiteMerchant/SiteTemplateMerchant.Master" AutoEventWireup="true" CodeBehind="商户提款导入TXT.aspx.cs" Inherits="web1.WebsiteMerchant.商户订单.商户提款导入TXT" %>
...
<asp:Content ID="Content_NR2" ContentPlaceHolderID="ContentPlaceHolder_NR2" runat="server">
    <h1>Merchant Take Money(Import TXT) 商户提款 文档导入</h1>
    <div>
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        ...
                        使用TXT导入预备订单 按要列为：交易方卡号，交易方姓名，交易方银行，交易金额，备注
                    </td>
                </tr>
                <tr>
                    <td>
