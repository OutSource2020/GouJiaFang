<%@ Page Title="商户提款" Language="C#" MasterPageFile="~/WebsiteMerchant/SiteTemplateMerchant.Master" AutoEventWireup="true" CodeBehind="商户提款.aspx.cs" Inherits="web1.WebsiteMerchant.商户订单.商户提款" %>
...
<asp:Content ID="Content_NR2" ContentPlaceHolderID="ContentPlaceHolder_NR2" runat="server">
    <div class="auto-style1">
        <h1>Merchant Take Money(Multiple) 商户提款</h1>
        <div>
