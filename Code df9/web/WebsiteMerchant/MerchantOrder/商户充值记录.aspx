<%@ Page Title="商户充值记录" Language="C#" MasterPageFile="~/WebsiteMerchant/SiteTemplateMerchant.Master" AutoEventWireup="true" CodeBehind="商户充值记录.aspx.cs" Inherits="web1.WebsiteMerchant.商户订单.商户充值记录" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td>
                ...
                <asp:Button ID="Button_商户充值" runat="server" Text="商户充值(余额/手续费)" class="btn btn-info btn-fw" OnClick="Button_商户充值_Click"  />
            </td>
        </tr>
        <tr>
            <td>
...
<asp:Label ID="Label_刷新时间" runat="server" Text=".."></asp:Label>
        ...
        <div>
         ...
         <table class="auto-style1">
            ...
            <tr>
                <td>&nbsp;<asp:Label ID="Label_账户提款余额" runat="server" Text="Label_账户提款余额"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="Label_账户手续费余额" runat="server" Text="Labe_账户手续费余额"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="Label_账户手续费比率" runat="server" Text="Labe_账户手续费比率"></asp:Label>
                </td>
            </tr>
        </table>
...
<Columns>
                    ...
                    <asp:BoundField DataField="商户充值目标姓名" HeaderText="目标姓名" />
                    <asp:BoundField DataField="商户充值目标卡号" HeaderText="目标卡号" />
                    <asp:BoundField DataField="商户充值目标银行" HeaderText="目标银行" />
